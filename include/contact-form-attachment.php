...
$recaptcha_secret_key = ''; // Add your reCaptcha Secret key if you wish to activate google reCaptcha security
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($email != '') {
        ...
        foreach (array("form-prefix", "subject") as $fld) {
        ...
        $response = array('response' => 'error', 'message' => 'Email is required.');
        echo json_encode($response);
    }
}
?>
